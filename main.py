...
container2.image("mesure femur.PNG", caption='mesure du fémur')
...
container2.image("mesure colonne.PNG", caption='mesure de la colonne vertébrale')
...
container2.image("mesure densite.PNG", caption='mesure de la densité osseuse')
